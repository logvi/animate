...
var Animate = function (_React$Component) {
  ...
  Animate.prototype.stop = function stop(key) {
    ...
    console.log('stop', key, this.childrenRefs);
    // console.log('stop', key, this.refs);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.performEnter = function (key) {
    ...
    // console.log('performEnter', key, this.refs);
    console.log('performEnter', key, _this5.childrenRefs);
  ...
  this.performAppear = function (key) {
    // console.log('performAppear', key, this.refs);
    console.log('performAppear', key, _this5.childrenRefs);
    if (_this5.childrenRefs[key]) {
      // if (this.refs[key]) {
      _this5.currentlyAnimatingKeys[key] = true;
  ...
  this.performLeave = function (key) {
    // may already remove by exclusive
    // console.log('performLeave', key, this.refs);
    console.log('performLeave', key, _this5.childrenRefs);
    if (_this5.childrenRefs[key]) {
      // if (this.refs[key]) {
      _this5.currentlyAnimatingKeys[key] = true;
